...
public class Lua_UnityEngine_Transform : LuaObject {
	...
	static public int SetParent(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.SetParent");
			#endif
	...
	static public int SetPositionAndRotation(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.SetPositionAndRotation");
			#endif
			UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
	...
	static public int Translate(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.Translate");
			#endif
			int argc = LuaDLL.pua_gettop(l);
			if(argc==2){
				UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
	...
	static public int Rotate(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.Rotate");
			#endif
			int argc = LuaDLL.pua_gettop(l);
			if(argc==2){
				UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
	...
	static public int TransformDirection(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.TransformDirection");
			#endif
			int argc = LuaDLL.pua_gettop(l);
			if(argc==2){
				UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
	...
	static public int InverseTransformDirection(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.InverseTransformDirection");
			#endif
			int argc = LuaDLL.pua_gettop(l);
			if(argc==2){
				UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
	...
	static public int TransformVector(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.TransformVector");
			#endif
			int argc = LuaDLL.pua_gettop(l);
			if(argc==2){
				UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
	...
	static public int InverseTransformVector(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.InverseTransformVector");
			#endif
			int argc = LuaDLL.pua_gettop(l);
			if(argc==2){
				UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
	...
	static public int TransformPoint(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.TransformPoint");
			#endif
			int argc = LuaDLL.pua_gettop(l);
			if(argc==2){
				UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
	...
	static public int InverseTransformPoint(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.InverseTransformPoint");
			#endif
			int argc = LuaDLL.pua_gettop(l);
			if(argc==2){
				UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
	...
	static public int SetAsFirstSibling(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.SetAsFirstSibling");
			#endif
			UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
	...
	static public int SetAsLastSibling(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.SetAsLastSibling");
			#endif
			UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
	...
	static public int SetSiblingIndex(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.SetSiblingIndex");
			#endif
			UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
			System.Int32 a1;
			checkType(l,2,out a1);
	...
	static public int GetSiblingIndex(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.GetSiblingIndex");
			#endif
			UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
	...
	static public int Find(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.Find");
			#endif
			UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
			System.String a1;
			checkType(l,2,out a1);
	...
	static public int IsChildOf(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.IsChildOf");
			#endif
			UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
			UnityEngine.Transform a1;
			checkType(l,2,out a1);
	...
	static public int GetChild(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.GetChild");
			#endif
			UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
			System.Int32 a1;
			checkType(l,2,out a1);
	...
	static public int get_position(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.position");
			#endif
			UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_localPosition(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.localPosition");
			#endif
			UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_rotation(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.rotation");
			#endif
			UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_localRotation(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.localRotation");
			#endif
			UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_localScale(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.localScale");
			#endif
			UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_parent(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.parent");
			#endif
			UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_worldToLocalMatrix(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.worldToLocalMatrix");
			#endif
			UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_localToWorldMatrix(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.localToWorldMatrix");
			#endif
			UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_root(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.root");
			#endif
			UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_childCount(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.childCount");
			#endif
			UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_hasChanged(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.hasChanged");
			#endif
			UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_hierarchyCapacity(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.hierarchyCapacity");
			#endif
			UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_hierarchyCount(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Transform.hierarchyCount");
			#endif
			UnityEngine.Transform self=(UnityEngine.Transform)checkSelf(l);
			pushValue(l,true);
