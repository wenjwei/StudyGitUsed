...
public class Lua_UnityEngine_Object : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Object.constructor");
			#endif
	...
	static public int GetInstanceID(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Object.GetInstanceID");
			#endif
	...
	static public int Instantiate_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Object.Instantiate");
			#endif
	...
	static public int Destroy_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Object.Destroy");
			#endif
			int argc = LuaDLL.pua_gettop(l);
			if(argc==1){
				UnityEngine.Object a1;
	...
	static public int DestroyImmediate_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Object.DestroyImmediate");
			#endif
			int argc = LuaDLL.pua_gettop(l);
			if(argc==1){
				UnityEngine.Object a1;
	...
	static public int FindObjectsOfType_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Object.FindObjectsOfType");
			#endif
			System.Type a1;
			checkType(l,1,out a1);
	...
	static public int DontDestroyOnLoad_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Object.DontDestroyOnLoad");
			#endif
			UnityEngine.Object a1;
			checkType(l,1,out a1);
	...
	static public int FindObjectOfType_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Object.FindObjectOfType");
			#endif
			System.Type a1;
			checkType(l,1,out a1);
	...
	static public int op_Equality(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Object.op_Equality");
			#endif
			UnityEngine.Object a1;
			checkType(l,1,out a1);
	...
	static public int op_Inequality(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Object.op_Inequality");
			#endif
			UnityEngine.Object a1;
			checkType(l,1,out a1);
			UnityEngine.Object a2;
	...
	static public int get_name(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Object.name");
			#endif
			UnityEngine.Object self=(UnityEngine.Object)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_hideFlags(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Object.hideFlags");
			#endif
			UnityEngine.Object self=(UnityEngine.Object)checkSelf(l);
			pushValue(l,true);
