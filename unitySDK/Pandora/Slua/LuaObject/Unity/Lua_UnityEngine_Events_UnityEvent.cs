...
public class Lua_UnityEngine_Events_UnityEvent : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Events.UnityEvent.constructor");
			#endif
	...
	static public int AddListener(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Events.UnityEvent.AddListener");
			#endif
	...
	static public int RemoveListener(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Events.UnityEvent.RemoveListener");
			#endif
			UnityEngine.Events.UnityEvent self=(UnityEngine.Events.UnityEvent)checkSelf(l);
			UnityEngine.Events.UnityAction a1;
			LuaDelegation.checkDelegate(l,2,out a1);
	...
	static public int Invoke(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Events.UnityEvent.Invoke");
			#endif
			UnityEngine.Events.UnityEvent self=(UnityEngine.Events.UnityEvent)checkSelf(l);
			self.Invoke();
			pushValue(l,true);
