...
public class Lua_UnityEngine_MonoBehaviour : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.MonoBehaviour.constructor");
			#endif
	...
	static public int IsInvoking(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.MonoBehaviour.IsInvoking");
			#endif
	...
	static public int CancelInvoke(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.MonoBehaviour.CancelInvoke");
			#endif
			int argc = LuaDLL.pua_gettop(l);
			if(argc==1){
				UnityEngine.MonoBehaviour self=(UnityEngine.MonoBehaviour)checkSelf(l);
	...
	static public int Invoke(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.MonoBehaviour.Invoke");
			#endif
			UnityEngine.MonoBehaviour self=(UnityEngine.MonoBehaviour)checkSelf(l);
			System.String a1;
			checkType(l,2,out a1);
	...
	static public int InvokeRepeating(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.MonoBehaviour.InvokeRepeating");
			#endif
			UnityEngine.MonoBehaviour self=(UnityEngine.MonoBehaviour)checkSelf(l);
			System.String a1;
			checkType(l,2,out a1);
	...
	static public int StartCoroutine(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.MonoBehaviour.StartCoroutine");
			#endif
			int argc = LuaDLL.pua_gettop(l);
	...
	static public int StopCoroutine(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.MonoBehaviour.StopCoroutine");
			#endif
			int argc = LuaDLL.pua_gettop(l);
	...
	static public int StopAllCoroutines(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.MonoBehaviour.StopAllCoroutines");
			#endif
			UnityEngine.MonoBehaviour self=(UnityEngine.MonoBehaviour)checkSelf(l);
	...
	static public int print_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.MonoBehaviour.print");
			#endif
			System.Object a1;
	...
	static public int get_useGUILayout(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.MonoBehaviour.useGUILayout");
			#endif
			UnityEngine.MonoBehaviour self=(UnityEngine.MonoBehaviour)checkSelf(l);
			pushValue(l,true);
