...
public class Lua_UnityEngine_Quaternion : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.constructor");
			#endif
	...
	static public int Set(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.Set");
			#endif
	...
	static public int SetLookRotation(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.SetLookRotation");
			#endif
	...
	static public int ToAngleAxis(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.ToAngleAxis");
			#endif
			UnityEngine.Quaternion self;
			checkType(l,1,out self);
			System.Single a1;
	...
	static public int SetFromToRotation(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.SetFromToRotation");
			#endif
			UnityEngine.Quaternion self;
			checkType(l,1,out self);
			UnityEngine.Vector3 a1;
	...
	static public int Normalize(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.Normalize");
			#endif
			UnityEngine.Quaternion self;
			checkType(l,1,out self);
			self.Normalize();
	...
	static public int FromToRotation_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.FromToRotation");
			#endif
			UnityEngine.Vector3 a1;
	...
	static public int Inverse_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.Inverse");
			#endif
	...
	static public int Slerp_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.Slerp");
			#endif
			UnityEngine.Quaternion a1;
			checkType(l,1,out a1);
	...
	static public int SlerpUnclamped_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.SlerpUnclamped");
			#endif
			UnityEngine.Quaternion a1;
			checkType(l,1,out a1);
			UnityEngine.Quaternion a2;
	...
	static public int Lerp_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.Lerp");
			#endif
			UnityEngine.Quaternion a1;
			checkType(l,1,out a1);
			UnityEngine.Quaternion a2;
	...
	static public int LerpUnclamped_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.LerpUnclamped");
			#endif
			UnityEngine.Quaternion a1;
			checkType(l,1,out a1);
			UnityEngine.Quaternion a2;
	...
	static public int AngleAxis_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.AngleAxis");
			#endif
			System.Single a1;
			checkType(l,1,out a1);
			UnityEngine.Vector3 a2;
	...
	static public int LookRotation_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.LookRotation");
			#endif
			int argc = LuaDLL.pua_gettop(l);
			if(argc==1){
				UnityEngine.Vector3 a1;
	...
	static public int op_Multiply(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.op_Multiply");
			#endif
			int argc = LuaDLL.pua_gettop(l);
	...
	static public int op_Equality(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.op_Equality");
			#endif
			UnityEngine.Quaternion a1;
			checkType(l,1,out a1);
			UnityEngine.Quaternion a2;
	...
	static public int op_Inequality(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.op_Inequality");
			#endif
			UnityEngine.Quaternion a1;
			checkType(l,1,out a1);
			UnityEngine.Quaternion a2;
	...
	static public int Dot_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.Dot");
			#endif
			UnityEngine.Quaternion a1;
			checkType(l,1,out a1);
			UnityEngine.Quaternion a2;
	...
	static public int Angle_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.Angle");
			#endif
			UnityEngine.Quaternion a1;
			checkType(l,1,out a1);
			UnityEngine.Quaternion a2;
	...
	static public int Euler_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.Euler");
			#endif
			int argc = LuaDLL.pua_gettop(l);
			if(argc==1){
				UnityEngine.Vector3 a1;
	...
	static public int RotateTowards_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.RotateTowards");
			#endif
			UnityEngine.Quaternion a1;
			checkType(l,1,out a1);
			UnityEngine.Quaternion a2;
	...
	static public int get_x(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.x");
			#endif
			UnityEngine.Quaternion self;
			checkType(l,1,out self);
			pushValue(l,true);
	...
	static public int get_y(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.y");
			#endif
			UnityEngine.Quaternion self;
			checkType(l,1,out self);
			pushValue(l,true);
	...
	static public int get_z(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.z");
			#endif
			UnityEngine.Quaternion self;
			checkType(l,1,out self);
			pushValue(l,true);
	...
	static public int get_w(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.w");
			#endif
			UnityEngine.Quaternion self;
			checkType(l,1,out self);
			pushValue(l,true);
	...
	static public int get_kEpsilon(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.kEpsilon");
			#endif
			pushValue(l,true);
	...
	static public int get_identity(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.identity");
			#endif
			pushValue(l,true);
	...
	static public int get_eulerAngles(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.eulerAngles");
			#endif
			UnityEngine.Quaternion self;
			checkType(l,1,out self);
			pushValue(l,true);
	...
	static public int get_normalized(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.normalized");
			#endif
			UnityEngine.Quaternion self;
			checkType(l,1,out self);
			pushValue(l,true);
	...
	static public int getItem(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.getItem");
			#endif
			UnityEngine.Quaternion self;
			checkType(l,1,out self);
			int v;
	...
	static public int setItem(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Quaternion.setItem");
			#endif
			UnityEngine.Quaternion self;
			checkType(l,1,out self);
			int v;
