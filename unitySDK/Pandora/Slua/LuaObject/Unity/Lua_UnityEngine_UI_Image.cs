...
public class Lua_UnityEngine_UI_Image : LuaObject {
	...
	static public int OnBeforeSerialize(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.OnBeforeSerialize");
			#endif
	...
	static public int OnAfterDeserialize(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.OnAfterDeserialize");
			#endif
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
	...
	static public int SetNativeSize(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.SetNativeSize");
			#endif
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
			self.SetNativeSize();
			pushValue(l,true);
	...
	static public int CalculateLayoutInputHorizontal(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.CalculateLayoutInputHorizontal");
			#endif
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
	...
	static public int CalculateLayoutInputVertical(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.CalculateLayoutInputVertical");
			#endif
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
	...
	static public int IsRaycastLocationValid(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.IsRaycastLocationValid");
			#endif
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
	...
	static public int get_sprite(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.sprite");
			#endif
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_overrideSprite(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.overrideSprite");
			#endif
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_type(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.type");
			#endif
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_preserveAspect(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.preserveAspect");
			#endif
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_fillCenter(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.fillCenter");
			#endif
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_fillMethod(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.fillMethod");
			#endif
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_fillAmount(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.fillAmount");
			#endif
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_fillClockwise(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.fillClockwise");
			#endif
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_fillOrigin(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.fillOrigin");
			#endif
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_alphaHitTestMinimumThreshold(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.alphaHitTestMinimumThreshold");
			#endif
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_useSpriteMesh(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.useSpriteMesh");
			#endif
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_defaultETC1GraphicMaterial(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.defaultETC1GraphicMaterial");
			#endif
			pushValue(l,true);
	...
	static public int get_mainTexture(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.mainTexture");
			#endif
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_hasBorder(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.hasBorder");
			#endif
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_pixelsPerUnit(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.pixelsPerUnit");
			#endif
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_material(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.material");
			#endif
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_minWidth(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.minWidth");
			#endif
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_preferredWidth(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.preferredWidth");
			#endif
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_flexibleWidth(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.flexibleWidth");
			#endif
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_minHeight(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.minHeight");
			#endif
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_preferredHeight(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.preferredHeight");
			#endif
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_flexibleHeight(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.flexibleHeight");
			#endif
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_layoutPriority(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Image.layoutPriority");
			#endif
			UnityEngine.UI.Image self=(UnityEngine.UI.Image)checkSelf(l);
			pushValue(l,true);
