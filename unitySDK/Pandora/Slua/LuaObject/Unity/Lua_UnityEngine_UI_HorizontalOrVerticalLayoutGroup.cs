...
public class Lua_UnityEngine_UI_HorizontalOrVerticalLayoutGroup : LuaObject {
	...
	static public int get_spacing(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.HorizontalOrVerticalLayoutGroup.spacing");
			#endif
	...
	static public int get_childForceExpandWidth(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.HorizontalOrVerticalLayoutGroup.childForceExpandWidth");
			#endif
			UnityEngine.UI.HorizontalOrVerticalLayoutGroup self=(UnityEngine.UI.HorizontalOrVerticalLayoutGroup)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_childForceExpandHeight(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.HorizontalOrVerticalLayoutGroup.childForceExpandHeight");
			#endif
			UnityEngine.UI.HorizontalOrVerticalLayoutGroup self=(UnityEngine.UI.HorizontalOrVerticalLayoutGroup)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_childControlWidth(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.HorizontalOrVerticalLayoutGroup.childControlWidth");
			#endif
			UnityEngine.UI.HorizontalOrVerticalLayoutGroup self=(UnityEngine.UI.HorizontalOrVerticalLayoutGroup)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_childControlHeight(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.HorizontalOrVerticalLayoutGroup.childControlHeight");
			#endif
			UnityEngine.UI.HorizontalOrVerticalLayoutGroup self=(UnityEngine.UI.HorizontalOrVerticalLayoutGroup)checkSelf(l);
			pushValue(l,true);
