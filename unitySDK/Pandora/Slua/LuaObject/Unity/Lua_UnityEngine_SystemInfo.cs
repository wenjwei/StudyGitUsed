...
public class Lua_UnityEngine_SystemInfo : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.constructor");
			#endif
	...
	static public int SupportsRenderTextureFormat_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.SupportsRenderTextureFormat");
			#endif
	...
	static public int SupportsBlendingOnRenderTextureFormat_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.SupportsBlendingOnRenderTextureFormat");
			#endif
			UnityEngine.RenderTextureFormat a1;
			checkEnum(l,1,out a1);
	...
	static public int SupportsTextureFormat_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.SupportsTextureFormat");
			#endif
	...
	static public int IsFormatSupported_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.IsFormatSupported");
			#endif
	...
	static public int get_unsupportedIdentifier(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.unsupportedIdentifier");
			#endif
			pushValue(l,true);
	...
	static public int get_batteryLevel(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.batteryLevel");
			#endif
			pushValue(l,true);
	...
	static public int get_batteryStatus(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.batteryStatus");
			#endif
			pushValue(l,true);
	...
	static public int get_operatingSystem(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.operatingSystem");
			#endif
			pushValue(l,true);
	...
	static public int get_operatingSystemFamily(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.operatingSystemFamily");
			#endif
			pushValue(l,true);
	...
	static public int get_processorType(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.processorType");
			#endif
			pushValue(l,true);
	...
	static public int get_processorFrequency(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.processorFrequency");
			#endif
			pushValue(l,true);
	...
	static public int get_processorCount(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.processorCount");
			#endif
			pushValue(l,true);
	...
	static public int get_systemMemorySize(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.systemMemorySize");
			#endif
			pushValue(l,true);
	...
	static public int get_deviceUniqueIdentifier(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.deviceUniqueIdentifier");
			#endif
			pushValue(l,true);
	...
	static public int get_deviceName(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.deviceName");
			#endif
			pushValue(l,true);
	...
	static public int get_deviceModel(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.deviceModel");
			#endif
			pushValue(l,true);
	...
	static public int get_supportsAccelerometer(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supportsAccelerometer");
			#endif
			pushValue(l,true);
	...
	static public int get_supportsGyroscope(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supportsGyroscope");
			#endif
			pushValue(l,true);
	...
	static public int get_supportsLocationService(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supportsLocationService");
			#endif
			pushValue(l,true);
	...
	static public int get_supportsVibration(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supportsVibration");
			#endif
			pushValue(l,true);
	...
	static public int get_supportsAudio(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supportsAudio");
			#endif
			pushValue(l,true);
	...
	static public int get_deviceType(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.deviceType");
			#endif
			pushValue(l,true);
	...
	static public int get_graphicsMemorySize(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.graphicsMemorySize");
			#endif
			pushValue(l,true);
	...
	static public int get_graphicsDeviceName(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.graphicsDeviceName");
			#endif
			pushValue(l,true);
	...
	static public int get_graphicsDeviceVendor(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.graphicsDeviceVendor");
			#endif
			pushValue(l,true);
	...
	static public int get_graphicsDeviceID(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.graphicsDeviceID");
			#endif
			pushValue(l,true);
	...
	static public int get_graphicsDeviceVendorID(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.graphicsDeviceVendorID");
			#endif
			pushValue(l,true);
	...
	static public int get_graphicsDeviceType(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.graphicsDeviceType");
			#endif
			pushValue(l,true);
	...
	static public int get_graphicsUVStartsAtTop(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.graphicsUVStartsAtTop");
			#endif
			pushValue(l,true);
	...
	static public int get_graphicsDeviceVersion(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.graphicsDeviceVersion");
			#endif
			pushValue(l,true);
	...
	static public int get_graphicsShaderLevel(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.graphicsShaderLevel");
			#endif
			pushValue(l,true);
	...
	static public int get_graphicsMultiThreaded(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.graphicsMultiThreaded");
			#endif
			pushValue(l,true);
	...
	static public int get_hasHiddenSurfaceRemovalOnGPU(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.hasHiddenSurfaceRemovalOnGPU");
			#endif
			pushValue(l,true);
	...
	static public int get_hasDynamicUniformArrayIndexingInFragmentShaders(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.hasDynamicUniformArrayIndexingInFragmentShaders");
			#endif
			pushValue(l,true);
	...
	static public int get_supportsShadows(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supportsShadows");
			#endif
			pushValue(l,true);
	...
	static public int get_supportsRawShadowDepthSampling(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supportsRawShadowDepthSampling");
			#endif
			pushValue(l,true);
	...
	static public int get_supportsMotionVectors(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supportsMotionVectors");
			#endif
			pushValue(l,true);
	...
	static public int get_supportsRenderToCubemap(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supportsRenderToCubemap");
			#endif
			pushValue(l,true);
	...
	static public int get_supportsImageEffects(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supportsImageEffects");
			#endif
			pushValue(l,true);
	...
	static public int get_supports3DTextures(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supports3DTextures");
			#endif
			pushValue(l,true);
	...
	static public int get_supports2DArrayTextures(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supports2DArrayTextures");
			#endif
			pushValue(l,true);
	...
	static public int get_supports3DRenderTextures(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supports3DRenderTextures");
			#endif
			pushValue(l,true);
	...
	static public int get_supportsCubemapArrayTextures(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supportsCubemapArrayTextures");
			#endif
			pushValue(l,true);
	...
	static public int get_copyTextureSupport(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.copyTextureSupport");
			#endif
			pushValue(l,true);
	...
	static public int get_supportsComputeShaders(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supportsComputeShaders");
			#endif
			pushValue(l,true);
	...
	static public int get_supportsInstancing(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supportsInstancing");
			#endif
			pushValue(l,true);
	...
	static public int get_supportsHardwareQuadTopology(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supportsHardwareQuadTopology");
			#endif
			pushValue(l,true);
	...
	static public int get_supports32bitsIndexBuffer(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supports32bitsIndexBuffer");
			#endif
			pushValue(l,true);
	...
	static public int get_supportsSparseTextures(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supportsSparseTextures");
			#endif
			pushValue(l,true);
	...
	static public int get_supportedRenderTargetCount(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supportedRenderTargetCount");
			#endif
			pushValue(l,true);
	...
	static public int get_supportsSeparatedRenderTargetsBlend(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supportsSeparatedRenderTargetsBlend");
			#endif
			pushValue(l,true);
	...
	static public int get_supportsMultisampledTextures(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supportsMultisampledTextures");
			#endif
			pushValue(l,true);
	...
	static public int get_supportsMultisampleAutoResolve(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supportsMultisampleAutoResolve");
			#endif
			pushValue(l,true);
	...
	static public int get_supportsTextureWrapMirrorOnce(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supportsTextureWrapMirrorOnce");
			#endif
			pushValue(l,true);
	...
	static public int get_usesReversedZBuffer(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.usesReversedZBuffer");
			#endif
			pushValue(l,true);
	...
	static public int get_npotSupport(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.npotSupport");
			#endif
			pushValue(l,true);
	...
	static public int get_maxTextureSize(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.maxTextureSize");
			#endif
			pushValue(l,true);
	...
	static public int get_maxCubemapSize(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.maxCubemapSize");
			#endif
			pushValue(l,true);
	...
	static public int get_supportsAsyncCompute(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supportsAsyncCompute");
			#endif
			pushValue(l,true);
	...
	static public int get_supportsGPUFence(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supportsGPUFence");
			#endif
			pushValue(l,true);
	...
	static public int get_supportsAsyncGPUReadback(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supportsAsyncGPUReadback");
			#endif
			pushValue(l,true);
	...
	static public int get_supportsMipStreaming(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.SystemInfo.supportsMipStreaming");
			#endif
			pushValue(l,true);
