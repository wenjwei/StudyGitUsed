...
public class Lua_UnityEngine_UI_Toggle : LuaObject {
	...
	static public int Rebuild(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Toggle.Rebuild");
			#endif
	...
	static public int LayoutComplete(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Toggle.LayoutComplete");
			#endif
			UnityEngine.UI.Toggle self=(UnityEngine.UI.Toggle)checkSelf(l);
			self.LayoutComplete();
			pushValue(l,true);
	...
	static public int GraphicUpdateComplete(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Toggle.GraphicUpdateComplete");
			#endif
			UnityEngine.UI.Toggle self=(UnityEngine.UI.Toggle)checkSelf(l);
	...
	static public int OnPointerClick(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Toggle.OnPointerClick");
			#endif
			UnityEngine.UI.Toggle self=(UnityEngine.UI.Toggle)checkSelf(l);
	...
	static public int OnSubmit(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Toggle.OnSubmit");
			#endif
			UnityEngine.UI.Toggle self=(UnityEngine.UI.Toggle)checkSelf(l);
	...
	static public int get_toggleTransition(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Toggle.toggleTransition");
			#endif
			UnityEngine.UI.Toggle self=(UnityEngine.UI.Toggle)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_graphic(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Toggle.graphic");
			#endif
			UnityEngine.UI.Toggle self=(UnityEngine.UI.Toggle)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_onValueChanged(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Toggle.onValueChanged");
			#endif
			UnityEngine.UI.Toggle self=(UnityEngine.UI.Toggle)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_group(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Toggle.group");
			#endif
			UnityEngine.UI.Toggle self=(UnityEngine.UI.Toggle)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_isOn(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Toggle.isOn");
			#endif
			UnityEngine.UI.Toggle self=(UnityEngine.UI.Toggle)checkSelf(l);
			pushValue(l,true);
