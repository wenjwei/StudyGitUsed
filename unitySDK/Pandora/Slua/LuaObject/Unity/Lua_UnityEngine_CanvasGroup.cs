...
public class Lua_UnityEngine_CanvasGroup : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.CanvasGroup.constructor");
			#endif
	...
	static public int IsRaycastLocationValid(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.CanvasGroup.IsRaycastLocationValid");
			#endif
	...
	static public int get_alpha(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.CanvasGroup.alpha");
			#endif
			UnityEngine.CanvasGroup self=(UnityEngine.CanvasGroup)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_interactable(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.CanvasGroup.interactable");
			#endif
			UnityEngine.CanvasGroup self=(UnityEngine.CanvasGroup)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_blocksRaycasts(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.CanvasGroup.blocksRaycasts");
			#endif
			UnityEngine.CanvasGroup self=(UnityEngine.CanvasGroup)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_ignoreParentGroups(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.CanvasGroup.ignoreParentGroups");
			#endif
			UnityEngine.CanvasGroup self=(UnityEngine.CanvasGroup)checkSelf(l);
			pushValue(l,true);
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(UnityEngine.CanvasGroup),typeof(UnityEngine.Behaviour));
	}
}
