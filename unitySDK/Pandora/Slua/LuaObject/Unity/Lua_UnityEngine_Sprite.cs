...
public class Lua_UnityEngine_Sprite : LuaObject {
	...
	static public int GetPhysicsShapeCount(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Sprite.GetPhysicsShapeCount");
			#endif
	...
	static public int GetPhysicsShapePointCount(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Sprite.GetPhysicsShapePointCount");
			#endif
			UnityEngine.Sprite self=(UnityEngine.Sprite)checkSelf(l);
			System.Int32 a1;
	...
	static public int GetPhysicsShape(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Sprite.GetPhysicsShape");
			#endif
			UnityEngine.Sprite self=(UnityEngine.Sprite)checkSelf(l);
			System.Int32 a1;
			checkType(l,2,out a1);
	...
	static public int OverridePhysicsShape(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Sprite.OverridePhysicsShape");
			#endif
			UnityEngine.Sprite self=(UnityEngine.Sprite)checkSelf(l);
	...
	static public int OverrideGeometry(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Sprite.OverrideGeometry");
			#endif
			UnityEngine.Sprite self=(UnityEngine.Sprite)checkSelf(l);
	...
	static public int Create_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Sprite.Create");
			#endif
	...
	static public int get_bounds(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Sprite.bounds");
			#endif
			UnityEngine.Sprite self=(UnityEngine.Sprite)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_rect(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Sprite.rect");
			#endif
			UnityEngine.Sprite self=(UnityEngine.Sprite)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_border(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Sprite.border");
			#endif
			UnityEngine.Sprite self=(UnityEngine.Sprite)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_texture(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Sprite.texture");
			#endif
			UnityEngine.Sprite self=(UnityEngine.Sprite)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_pixelsPerUnit(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Sprite.pixelsPerUnit");
			#endif
			UnityEngine.Sprite self=(UnityEngine.Sprite)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_associatedAlphaSplitTexture(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Sprite.associatedAlphaSplitTexture");
			#endif
			UnityEngine.Sprite self=(UnityEngine.Sprite)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_pivot(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Sprite.pivot");
			#endif
			UnityEngine.Sprite self=(UnityEngine.Sprite)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_packed(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Sprite.packed");
			#endif
			UnityEngine.Sprite self=(UnityEngine.Sprite)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_packingMode(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Sprite.packingMode");
			#endif
			UnityEngine.Sprite self=(UnityEngine.Sprite)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_packingRotation(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Sprite.packingRotation");
			#endif
			UnityEngine.Sprite self=(UnityEngine.Sprite)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_textureRect(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Sprite.textureRect");
			#endif
			UnityEngine.Sprite self=(UnityEngine.Sprite)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_textureRectOffset(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Sprite.textureRectOffset");
			#endif
			UnityEngine.Sprite self=(UnityEngine.Sprite)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_vertices(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Sprite.vertices");
			#endif
			UnityEngine.Sprite self=(UnityEngine.Sprite)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_triangles(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Sprite.triangles");
			#endif
			UnityEngine.Sprite self=(UnityEngine.Sprite)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_uv(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Sprite.uv");
			#endif
			UnityEngine.Sprite self=(UnityEngine.Sprite)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.uv);
