...
public class Lua_UnityEngine_UI_Shadow : LuaObject {
	...
	static public int ModifyMesh(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Shadow.ModifyMesh");
			#endif
	...
	static public int get_effectColor(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Shadow.effectColor");
			#endif
			UnityEngine.UI.Shadow self=(UnityEngine.UI.Shadow)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_effectDistance(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Shadow.effectDistance");
			#endif
			UnityEngine.UI.Shadow self=(UnityEngine.UI.Shadow)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_useGraphicAlpha(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Shadow.useGraphicAlpha");
			#endif
			UnityEngine.UI.Shadow self=(UnityEngine.UI.Shadow)checkSelf(l);
			pushValue(l,true);
