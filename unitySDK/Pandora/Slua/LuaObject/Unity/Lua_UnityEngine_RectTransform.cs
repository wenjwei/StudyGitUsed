...
public class Lua_UnityEngine_RectTransform : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.RectTransform.constructor");
			#endif
	...
	static public int ForceUpdateRectTransforms(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.RectTransform.ForceUpdateRectTransforms");
			#endif
	...
	static public int GetLocalCorners(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.RectTransform.GetLocalCorners");
			#endif
			UnityEngine.RectTransform self=(UnityEngine.RectTransform)checkSelf(l);
	...
	static public int GetWorldCorners(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.RectTransform.GetWorldCorners");
			#endif
			UnityEngine.RectTransform self=(UnityEngine.RectTransform)checkSelf(l);
			UnityEngine.Vector3[] a1;
			checkArray(l,2,out a1);
	...
	static public int SetInsetAndSizeFromParentEdge(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.RectTransform.SetInsetAndSizeFromParentEdge");
			#endif
			UnityEngine.RectTransform self=(UnityEngine.RectTransform)checkSelf(l);
	...
	static public int SetSizeWithCurrentAnchors(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.RectTransform.SetSizeWithCurrentAnchors");
			#endif
			UnityEngine.RectTransform self=(UnityEngine.RectTransform)checkSelf(l);
	...
	static public int get_rect(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.RectTransform.rect");
			#endif
			UnityEngine.RectTransform self=(UnityEngine.RectTransform)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_anchorMin(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.RectTransform.anchorMin");
			#endif
			UnityEngine.RectTransform self=(UnityEngine.RectTransform)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_anchorMax(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.RectTransform.anchorMax");
			#endif
			UnityEngine.RectTransform self=(UnityEngine.RectTransform)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_anchoredPosition(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.RectTransform.anchoredPosition");
			#endif
			UnityEngine.RectTransform self=(UnityEngine.RectTransform)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_sizeDelta(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.RectTransform.sizeDelta");
			#endif
			UnityEngine.RectTransform self=(UnityEngine.RectTransform)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_pivot(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.RectTransform.pivot");
			#endif
			UnityEngine.RectTransform self=(UnityEngine.RectTransform)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_anchoredPosition3D(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.RectTransform.anchoredPosition3D");
			#endif
			UnityEngine.RectTransform self=(UnityEngine.RectTransform)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_offsetMin(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.RectTransform.offsetMin");
			#endif
			UnityEngine.RectTransform self=(UnityEngine.RectTransform)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_offsetMax(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.RectTransform.offsetMax");
			#endif
			UnityEngine.RectTransform self=(UnityEngine.RectTransform)checkSelf(l);
			pushValue(l,true);
