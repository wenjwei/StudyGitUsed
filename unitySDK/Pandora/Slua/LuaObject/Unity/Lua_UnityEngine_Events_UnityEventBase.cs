...
public class Lua_UnityEngine_Events_UnityEventBase : LuaObject {
	...
	static public int GetPersistentEventCount(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Events.UnityEventBase.GetPersistentEventCount");
			#endif
	...
	static public int GetPersistentTarget(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Events.UnityEventBase.GetPersistentTarget");
			#endif
			UnityEngine.Events.UnityEventBase self=(UnityEngine.Events.UnityEventBase)checkSelf(l);
			System.Int32 a1;
	...
	static public int GetPersistentMethodName(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Events.UnityEventBase.GetPersistentMethodName");
			#endif
			UnityEngine.Events.UnityEventBase self=(UnityEngine.Events.UnityEventBase)checkSelf(l);
			System.Int32 a1;
			checkType(l,2,out a1);
	...
	static public int SetPersistentListenerState(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Events.UnityEventBase.SetPersistentListenerState");
			#endif
			UnityEngine.Events.UnityEventBase self=(UnityEngine.Events.UnityEventBase)checkSelf(l);
			System.Int32 a1;
			checkType(l,2,out a1);
	...
	static public int RemoveAllListeners(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Events.UnityEventBase.RemoveAllListeners");
			#endif
			UnityEngine.Events.UnityEventBase self=(UnityEngine.Events.UnityEventBase)checkSelf(l);
	...
	static public int GetValidMethodInfo_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Events.UnityEventBase.GetValidMethodInfo");
			#endif
			System.Object a1;
