...
public class Lua_UnityEngine_UI_Text : LuaObject {
	...
	static public int FontTextureChanged(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.FontTextureChanged");
			#endif
	...
	static public int GetGenerationSettings(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.GetGenerationSettings");
			#endif
			UnityEngine.UI.Text self=(UnityEngine.UI.Text)checkSelf(l);
	...
	static public int CalculateLayoutInputHorizontal(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.CalculateLayoutInputHorizontal");
			#endif
			UnityEngine.UI.Text self=(UnityEngine.UI.Text)checkSelf(l);
	...
	static public int CalculateLayoutInputVertical(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.CalculateLayoutInputVertical");
			#endif
			UnityEngine.UI.Text self=(UnityEngine.UI.Text)checkSelf(l);
	...
	static public int GetTextAnchorPivot_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.GetTextAnchorPivot");
			#endif
	...
	static public int get_cachedTextGenerator(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.cachedTextGenerator");
			#endif
			UnityEngine.UI.Text self=(UnityEngine.UI.Text)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_cachedTextGeneratorForLayout(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.cachedTextGeneratorForLayout");
			#endif
			UnityEngine.UI.Text self=(UnityEngine.UI.Text)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_mainTexture(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.mainTexture");
			#endif
			UnityEngine.UI.Text self=(UnityEngine.UI.Text)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_font(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.font");
			#endif
			UnityEngine.UI.Text self=(UnityEngine.UI.Text)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_text(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.text");
			#endif
			UnityEngine.UI.Text self=(UnityEngine.UI.Text)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_supportRichText(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.supportRichText");
			#endif
			UnityEngine.UI.Text self=(UnityEngine.UI.Text)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_resizeTextForBestFit(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.resizeTextForBestFit");
			#endif
			UnityEngine.UI.Text self=(UnityEngine.UI.Text)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_resizeTextMinSize(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.resizeTextMinSize");
			#endif
			UnityEngine.UI.Text self=(UnityEngine.UI.Text)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_resizeTextMaxSize(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.resizeTextMaxSize");
			#endif
			UnityEngine.UI.Text self=(UnityEngine.UI.Text)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_alignment(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.alignment");
			#endif
			UnityEngine.UI.Text self=(UnityEngine.UI.Text)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_alignByGeometry(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.alignByGeometry");
			#endif
			UnityEngine.UI.Text self=(UnityEngine.UI.Text)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_fontSize(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.fontSize");
			#endif
			UnityEngine.UI.Text self=(UnityEngine.UI.Text)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_horizontalOverflow(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.horizontalOverflow");
			#endif
			UnityEngine.UI.Text self=(UnityEngine.UI.Text)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_verticalOverflow(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.verticalOverflow");
			#endif
			UnityEngine.UI.Text self=(UnityEngine.UI.Text)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_lineSpacing(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.lineSpacing");
			#endif
			UnityEngine.UI.Text self=(UnityEngine.UI.Text)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_fontStyle(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.fontStyle");
			#endif
			UnityEngine.UI.Text self=(UnityEngine.UI.Text)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_pixelsPerUnit(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.pixelsPerUnit");
			#endif
			UnityEngine.UI.Text self=(UnityEngine.UI.Text)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_minWidth(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.minWidth");
			#endif
			UnityEngine.UI.Text self=(UnityEngine.UI.Text)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_preferredWidth(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.preferredWidth");
			#endif
			UnityEngine.UI.Text self=(UnityEngine.UI.Text)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_flexibleWidth(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.flexibleWidth");
			#endif
			UnityEngine.UI.Text self=(UnityEngine.UI.Text)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_minHeight(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.minHeight");
			#endif
			UnityEngine.UI.Text self=(UnityEngine.UI.Text)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_preferredHeight(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.preferredHeight");
			#endif
			UnityEngine.UI.Text self=(UnityEngine.UI.Text)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_flexibleHeight(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.flexibleHeight");
			#endif
			UnityEngine.UI.Text self=(UnityEngine.UI.Text)checkSelf(l);
			pushValue(l,true);
	...
	static public int get_layoutPriority(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.Text.layoutPriority");
			#endif
			UnityEngine.UI.Text self=(UnityEngine.UI.Text)checkSelf(l);
			pushValue(l,true);
