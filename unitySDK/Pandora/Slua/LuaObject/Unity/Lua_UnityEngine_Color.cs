...
public class Lua_UnityEngine_Color : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.constructor");
			#endif
	...
	static public int op_Addition(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.op_Addition");
			#endif
	...
	static public int op_Subtraction(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.op_Subtraction");
			#endif
			UnityEngine.Color a1;
			checkType(l,1,out a1);
			UnityEngine.Color a2;
	...
	static public int op_Equality(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.op_Equality");
			#endif
			UnityEngine.Color a1;
			checkType(l,1,out a1);
			UnityEngine.Color a2;
	...
	static public int LerpUnclamped_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.LerpUnclamped");
			#endif
			UnityEngine.Color a1;
			checkType(l,1,out a1);
			UnityEngine.Color a2;
	...
	static public int RGBToHSV_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.RGBToHSV");
			#endif
			UnityEngine.Color a1;
			checkType(l,1,out a1);
			System.Single a2;
	...
	static public int HSVToRGB_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.HSVToRGB");
			#endif
			int argc = LuaDLL.pua_gettop(l);
			if(argc==3){
				System.Single a1;
	...
	static public int get_r(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.r");
			#endif
	...
	static public int get_g(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.g");
			#endif
			UnityEngine.Color self;
			checkType(l,1,out self);
			pushValue(l,true);
	...
	static public int get_b(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.b");
			#endif
			UnityEngine.Color self;
			checkType(l,1,out self);
			pushValue(l,true);
	...
	static public int get_a(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.a");
			#endif
			UnityEngine.Color self;
			checkType(l,1,out self);
			pushValue(l,true);
	...
	static public int get_red(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.red");
			#endif
			pushValue(l,true);
	...
	static public int get_green(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.green");
			#endif
			pushValue(l,true);
	...
	static public int get_blue(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.blue");
			#endif
			pushValue(l,true);
	...
	static public int get_white(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.white");
			#endif
			pushValue(l,true);
	...
	static public int get_black(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.black");
			#endif
			pushValue(l,true);
	...
	static public int get_yellow(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.yellow");
			#endif
			pushValue(l,true);
	...
	static public int get_cyan(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.cyan");
			#endif
			pushValue(l,true);
	...
	static public int get_magenta(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.magenta");
			#endif
			pushValue(l,true);
	...
	static public int get_gray(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.gray");
			#endif
			pushValue(l,true);
	...
	static public int get_grey(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.grey");
			#endif
			pushValue(l,true);
	...
	static public int get_clear(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.clear");
			#endif
			pushValue(l,true);
	...
	static public int get_grayscale(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.grayscale");
			#endif
			UnityEngine.Color self;
			checkType(l,1,out self);
			pushValue(l,true);
	...
	static public int get_linear(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.linear");
			#endif
			UnityEngine.Color self;
			checkType(l,1,out self);
			pushValue(l,true);
	...
	static public int get_gamma(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.gamma");
			#endif
			UnityEngine.Color self;
			checkType(l,1,out self);
			pushValue(l,true);
	...
	static public int get_maxColorComponent(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.maxColorComponent");
			#endif
			UnityEngine.Color self;
			checkType(l,1,out self);
			pushValue(l,true);
	...
	static public int getItem(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.getItem");
			#endif
			UnityEngine.Color self;
			checkType(l,1,out self);
			int v;
	...
	static public int setItem(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.Color.setItem");
			#endif
			UnityEngine.Color self;
			checkType(l,1,out self);
			int v;
