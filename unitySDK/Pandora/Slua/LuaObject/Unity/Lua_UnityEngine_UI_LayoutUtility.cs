...
public class Lua_UnityEngine_UI_LayoutUtility : LuaObject {
	...
	static public int GetMinSize_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.LayoutUtility.GetMinSize");
			#endif
	...
	static public int GetPreferredSize_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.LayoutUtility.GetPreferredSize");
			#endif
			UnityEngine.RectTransform a1;
			checkType(l,1,out a1);
			System.Int32 a2;
	...
	static public int GetFlexibleSize_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.LayoutUtility.GetFlexibleSize");
			#endif
			UnityEngine.RectTransform a1;
			checkType(l,1,out a1);
			System.Int32 a2;
	...
	static public int GetMinWidth_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.LayoutUtility.GetMinWidth");
			#endif
			UnityEngine.RectTransform a1;
			checkType(l,1,out a1);
	...
	static public int GetPreferredWidth_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.LayoutUtility.GetPreferredWidth");
			#endif
			UnityEngine.RectTransform a1;
			checkType(l,1,out a1);
	...
	static public int GetFlexibleWidth_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.LayoutUtility.GetFlexibleWidth");
			#endif
			UnityEngine.RectTransform a1;
			checkType(l,1,out a1);
	...
	static public int GetMinHeight_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.LayoutUtility.GetMinHeight");
			#endif
			UnityEngine.RectTransform a1;
			checkType(l,1,out a1);
	...
	static public int GetPreferredHeight_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.LayoutUtility.GetPreferredHeight");
			#endif
			UnityEngine.RectTransform a1;
			checkType(l,1,out a1);
	...
	static public int GetFlexibleHeight_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.LayoutUtility.GetFlexibleHeight");
			#endif
			UnityEngine.RectTransform a1;
			checkType(l,1,out a1);
	...
	static public int GetLayoutProperty_s(IntPtr l) {
		try {
			#if PANDORA_PROFILE
			beginSample("[C#]UnityEngine.UI.LayoutUtility.GetLayoutProperty");
			#endif
