...
namespace com.tencent.pandora
{
    public class GIFDecoder
    {
        ...
        /// <summary>
        /// useLinear:是否使用Linear Color Space
        /// </summary>
        /// <param name="data"></param>
        /// <param name="useLinear"></param>
        /// <returns></returns>
        public static Texture2D Decode(byte[] data, bool useLinear)
        {
            if (mInstance == null)
            {
            ...
            if (mInstance.Read(data, useLinear) == STATUS_OK)
            {
         ...
         */
        public int Read(byte[] data, bool useLinear)
        {
            Init();
            if (data != null)
            {
         ...
         */
        protected void ReadContents(bool useLinear)
        {
         ...
         */
        protected void ReadImage(bool useLinear)
        {
            ...
            mTexture = new Texture2D(width, height, TextureFormat.ARGB32, false, useLinear);
